...
export function walkingCharacterSprite() {
    ...
    ctx.drawImage(walkingSpriteSheet, ((getAnimationFrame() - 1) * walkingSpriteSheetDimensions.width) /
        walkingSprites, 0, walkingSpriteSheetDimensions.width / walkingSprites, walkingSpriteSheetDimensions.height, 0, 0, walkingSpriteSheetDimensions.width / walkingSprites, walkingSpriteSheetDimensions.height);
    return canvas;
}
export function idleCharacterSprite() {
    ...
    /* Draw the image on the new canvas */
    ctx.drawImage(idleSpriteSheet, ((getAnimationFrame() - 1) * idleSpriteSheetDimensions.width) / idleSprites, 0, idleSpriteSheetDimensions.width / idleSprites, idleSpriteSheetDimensions.height, 0, 0, idleSpriteSheetDimensions.width / idleSprites, idleSpriteSheetDimensions.height);
    return canvas;
}
